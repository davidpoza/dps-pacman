...
function Controller() {
    ...
    this.threshold = 150, //distancia minima requerida para considerar un swipe
    this.restraint = 100, // distancia máxima para considerar swipe
    this.allowedTime = 300, // tiempo maximo para realizar el swipe
    this.startTime = 0;
