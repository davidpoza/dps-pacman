...
Ghost.prototype.collides = function(ax,ay){
    let xOverlap = valueInRange(ax, this.x, this.x+COLLISION_SIZE) || valueInRange(this.x, ax, ax+COLLISION_SIZE);
    let yOverlap = valueInRange(ay, this.y, this.y+COLLISION_SIZE) || valueInRange(this.y, ay, ay+COLLISION_SIZE);
