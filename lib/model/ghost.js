...
Ghost.prototype.live = function(game){
    if(game.frames_rendered == 8*FPS) // a los 7 segundos
        this.setChaseMode(game.pacman);
    else if(game.frames_rendered == 29*FPS) // a los 20 segundos después
        this.setScatterMode(game.pacman);
    this.changeDir();    
