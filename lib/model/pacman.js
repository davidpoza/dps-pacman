...
Pacman.prototype.eatBall = function(game){    
    ...
    if(eated_ball == 1){ //bola normal vale 10pts
        ...
        if(game.points_notification.length == 0){
            game.points_notification = [this.x, this.y+24, CHERRY_SCORE];
            game.paused = true;
        ...
        if(game.points_notification.length == 0){
            game.points_notification = [this.x, this.y+24, STRAWBERRY_SCORE];
            game.paused = true;
            setTimeout(game.removePointsNotification.bind(game), 1000);
        }
    }
        ...
        if(game.points_notification.length == 0){
            game.points_notification = [this.x, this.y+24, ORANGE_SCORE];
            game.paused = true;
            setTimeout(game.removePointsNotification.bind(game), 1000);
        }
    }
        ...
        if(game.points_notification.length == 0){
            game.points_notification = [this.x, this.y+24, APPLE_SCORE];
            game.paused = true;
            setTimeout(game.removePointsNotification.bind(game), 1000);
        }
    }
        ...
        if(game.points_notification.length == 0){
            game.points_notification = [this.x, this.y+24, GRAPES_SCORE];
            game.paused = true;
            setTimeout(game.removePointsNotification.bind(game), 1000);
        }
    }
        ...
        if(game.points_notification.length == 0){
            game.points_notification = [this.x, this.y+24, GALAXIAN_SCORE];
            game.paused = true;
            setTimeout(game.removePointsNotification.bind(game), 1000);
        }
    }
        ...
        if(game.points_notification.length == 0){
            game.points_notification = [this.x, this.y+24, BELL_SCORE];
            game.paused = true;
            setTimeout(game.removePointsNotification.bind(game), 1000);
        }
    }
