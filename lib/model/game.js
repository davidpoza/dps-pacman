...
*/
Game.prototype.manageGhostReturning = function(){
    if(this.blinky.inReturningTile() && this.blinky.behaviour == "returning"){
        this.closeHome("blinky");
        this.blinky.behaviour = "waiting";
    }
    if(this.inky.inReturningTile() && this.inky.behaviour == "returning"){
        this.closeHome("inky");
        this.blinky.behaviour = "waiting";
    }
    if(this.clyde.inReturningTile() && this.clyde.behaviour == "returning"){
        this.closeHome("clyde");
        this.blinky.behaviour = "waiting";
    }
    if(this.pinky.inReturningTile() && this.pinky.behaviour == "returning"){
        this.closeHome("pinky");
        this.blinky.behaviour = "waiting";
    }
...
Game.prototype.checkPacmanGhostsCollision = function(){    
    ...
    if(pacman[0] == blinky[0] && pacman[1] == blinky[1]){
        if(this.blinky.behaviour != "frightened" && this.blinky.behaviour != "returning"){
            ...
            this.blinky.targetTile = [...BLINKY_RETURNING_TILE];
            this.openHome("inky"); // cuando es comido, blinky ocupa el mismo lugar que inky dentro del home
        }
    }
    if(pacman[0] == inky[0] && pacman[1] == inky[1]){
        if(this.inky.behaviour != "frightened" && this.inky.behaviour != "returning"){
            ...
            this.inky.targetTile = [...INKY_RETURNING_TILE];
            this.openHome("inky");
        }
    }
    if(pacman[0] == clyde[0] && pacman[1] == clyde[1]){
        if(this.clyde.behaviour != "frightened" && this.clyde.behaviour != "returning"){
            ...
            this.clyde.targetTile = [...CLYDE_RETURNING_TILE];
            this.openHome("clyde");
        }
    }
    if(pacman[0] == pinky[0] && pacman[1] == pinky[1]){
        if(this.pinky.behaviour != "frightened" && this.pinky.behaviour != "returning"){
            ...
            this.pinky.targetTile = [...PINKY_RETURNING_TILE];
            this.openHome("pinky");
        }
    }
