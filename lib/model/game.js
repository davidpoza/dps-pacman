...
Game.prototype.checkPacmanGhostsCollision = function(assets_manager){    
    ...
    if(pacman[0] == blinky[0] && pacman[1] == blinky[1]){
        if(this.blinky.behaviour != "frightened" && this.blinky.behaviour != "returning"){
            ...
            if(this.removePointsNotification.length == 0 && this.blinky.behaviour != "returning"){
                this.points_notification = [this.pacman.x, this.pacman.y+24, this.points_per_ghost];
    ...
    if(pacman[0] == inky[0] && pacman[1] == inky[1]){
        if(this.inky.behaviour != "frightened" && this.inky.behaviour != "returning"){
            ...
            if(this.removePointsNotification.length == 0 && this.inky.behaviour != "returning"){
                this.points_notification = [this.pacman.x, this.pacman.y+24, this.points_per_ghost];
                this.incScore(this.points_per_ghost);
                this.points_per_ghost *= 2;                
                this.paused = true;
    ...
    if(pacman[0] == clyde[0] && pacman[1] == clyde[1]){
        if(this.clyde.behaviour != "frightened" && this.clyde.behaviour != "returning"){
            ...
            if(this.removePointsNotification.length == 0 && this.clyde.behaviour != "returning"){
                this.points_notification = [this.pacman.x, this.pacman.y+24, this.points_per_ghost];
                this.incScore(this.points_per_ghost);
                this.points_per_ghost *= 2;                
                this.paused = true;
    ...
    if(pacman[0] == pinky[0] && pacman[1] == pinky[1]){
        if(this.pinky.behaviour != "frightened" && this.pinky.behaviour != "returning"){
            ...
            if(this.removePointsNotification.length == 0 && this.pinky.behaviour != "returning"){
                this.points_notification = [this.pacman.x, this.pacman.y+24, this.points_per_ghost];
                this.incScore(this.points_per_ghost);
                this.points_per_ghost *= 2;                
                this.paused = true;
